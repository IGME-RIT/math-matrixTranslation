...
Matrix4D MakeTranslation(Vector3D v)
{
...
Vector4D Translate(Vector3D v, Vector3D r)
{
	Vector4D originalVector = Vector4D(v, 1.0f);
	Matrix4D translateMatrix = MakeTranslation(r);
