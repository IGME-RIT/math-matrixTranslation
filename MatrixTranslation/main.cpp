...
int main()
{
	...
	// Translate Vector from one position to another
	Vector3D originalVector = Vector3D(10.0f, 5.0f, 1.0f);
	Vector3D translateVector = Vector3D(1.0f, 1.0f, 1.0f);

	Vector4D resultVector = Translate(originalVector, translateVector);

	std::cout << "\nThe translated Vector is:" << std::endl;
